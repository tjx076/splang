...
public class Expr6<T1,T2,T3, T4,T5, T6,R> extends BaseExpr {

	public Expr6(LangVisitor visitor, Expr expr) {
		super(visitor, expr);
	}
	...
	public R apply(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6) {
		...
		String key6 = exprArgList.get(5).getVal();
