...
1. SPL是一个轻量好玩的脚本语言，可以很方便的嵌入到应用程序里，从而为应用程序提供灵活的扩展和定制功能；
...
1. 提供Java任意方法和任意对象的声明和函数调用
2. 提供一个SPL语法检查、高亮和格式化的工具，实现代码风格的统一，利于代码编写，也利用后期维护
3. 目前SPL在解析和解释过程中，错误提示信息不够友好，需要提供语义级别的错误提示，方便定位语法错误
